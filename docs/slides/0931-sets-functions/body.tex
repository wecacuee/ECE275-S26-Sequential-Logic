...
Suppose that in Example 7, the inscriptions on Trunks 1,
...
{\color{sol}
  \begin{align}
  e \in A \cap B = e \in (A \cap B) = (e \in A) \land (e \in B)
  \end{align}
  \begin{align}
    e \in \overline{A \cap B} = \neg((e \in A) \land (e \in B)) = (\neg(e \in A) \lor \neg(e \in B)) = (e \notin A) \lor (e \in B)
  \end{align}
  \begin{align}
    e \in (\bar{A} \cup \bar{B}) = (e \in \bar{A}) \lor (e \in \bar{B}) = (e \notin A) \lor (e \notin B)
  \end{align}
}
